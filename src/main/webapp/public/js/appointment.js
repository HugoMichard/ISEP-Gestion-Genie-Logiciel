...
var Appointment = function (_Common) {
    _inherits(Appointment, _Common);

    function Appointment(options) {
        _classCallCheck(this, Appointment);

        var _this = _possibleConstructorReturn(this, (Appointment.__proto__ || Object.getPrototypeOf(Appointment)).call(this, options));
    ...
    _createClass(Appointment, [{
        ...
        value: function initTimer() {
            ...
            var $buttonStart = $('button[data-start-timer]'),
                $buttonStop = $('button[data-stop-timer]');

            // Timer inputs
            var $timerInput = $('input[data-timer]'),
            ...
            $buttonStart.on('click', function (event) {
                ...
                that.timer = setInterval(function () {
                    ...
                    var minutes = that.pad(Math.floor(that.timeSpent / 60), 2);
                    var seconds = that.pad(that.timeSpent % 60, 2);

                    var timeSpentString = minutes + ":" + seconds;
...
},{"./common.js":4,"jquery":2}],4:[function(require,module,exports){
(function (global){
'use strict';
