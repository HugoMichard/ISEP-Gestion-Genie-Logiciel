...
var Subject = function (_Common) {
    _inherits(Subject, _Common);

    function Subject(options) {
        _classCallCheck(this, Subject);

        var _this = _possibleConstructorReturn(this, (Subject.__proto__ || Object.getPrototypeOf(Subject)).call(this, options));

        _this.initCKEDITOR();
        _this.initFunctionalities();
        return _this;
    }
    ...
    _createClass(Subject, [{
        ...
        key: 'initFunctionalities',
        value: function initFunctionalities() {
            ...
            $('[data-functionalities]').on('click', '[data-functionality-up]', function (e) {
                var $functionality = $(e.target).closest('[data-functionality]'),
            ...
            $('[data-functionalities]').on('click', '[data-functionality-remove]', function (e) {
                ...
                if (parseInt(functionalityID) > 0) {
                    var ids = that.$functionalityContainer.find('input[name="functionalities_to_delete"]').val().split(","),
        ...
        key: 'reIndexFunctionalities',
        value: function reIndexFunctionalities() {
            this.functionalityCounter = 1;

            var that = this;

            $('[data-functionality]').each(function () {
                var $functionality = $(this);
        ...
        key: 'reOrderFunctionalities',
        value: function reOrderFunctionalities() {
            var $functionalities = this.$functionalityContainer.children('[data-functionality]');
        ...
        key: 'newFunctionality',
        value: function newFunctionality() {
            this.functionalityCounter += 1;

            var $functionality = $('<tr data-functionality data-functionality-priority="' + this.functionalityCounter + '">'),
                $priorityCol = $('<td>'),
                $functionalityCol = $('<td>'),
...
var app = new Subject(typeof settings !== 'undefined' ? settings : {});

},{"./common.js":3,"jquery":2}]},{},[4]);
